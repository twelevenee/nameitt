    ...
    <div id="main-content" className="min-h-screen flex flex-col" style={{ background: "var(--gradient-warm)" }}>
      <div className="flex-1 flex items-center justify-center px-6 py-20">
        <div className="max-w-2xl text-center space-y-8">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl leading-tight text-foreground">
            Was I too sensitive, or was something wrong?
          </h1>

          <p className="text-lg sm:text-xl text-muted-foreground max-w-lg mx-auto leading-relaxed">
            A reflective tool to help you name uncomfortable experiences without self-blame.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Button asChild size="lg" className="rounded-full px-8 text-base h-12 shadow-md">
              <Link to="/reflect">Reflect on an experience</Link>
            </Button>
            <Button asChild variant="ghost" size="lg" className="rounded-full px-6 text-base h-12 text-muted-foreground">
